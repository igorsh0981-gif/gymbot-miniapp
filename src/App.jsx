...
function tSport(sport) {
  if (!sport) return "";
  const lang = LANG_STORE.current;
  if (lang !== "ru" && sport["name_" + lang]) return sport["name_" + lang];
  return sport.name || sport.name_ru || "";
}
...
const DIFF_LABEL={easy:t("difficulty_easy"),medium:t("difficulty_medium"),hard:t("difficulty_hard")};
