        ...
        {norms.norms.map((n,i)=>{
          ...
          return<div key={i} style={{marginBottom:12,paddingBottom:12,borderBottom:i<norms.norms.length-1?`0.5px solid ${C.border}`:"none"}}>
            <div style={{display:"flex",justifyContent:"space-between",marginBottom:4}}>
              ...
              <div style={{textAlign:"right"}}>
                {n.your_max
                  ?<><Mono size={13}>{n.your_max}кг</Mono><span style={{fontSize:11,color:levelColor,marginLeft:6}}>{levelLabel}</span></>
            ...
            <div style={{display:"flex",justifyContent:"space-between",marginTop:4,fontSize:10,color:C.muted,fontFamily:"monospace"}}>
              <span>Нач: {n.levels.beginner}кг</span>
              <span>Ср: {n.levels.intermediate}кг</span>
              <span>Прод: {n.levels.advanced}кг</span>
              <span>Элита: {n.levels.elite}кг</span>
            </div>
          </div>;
        })}
      </div>}
