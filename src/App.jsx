...
const T = {
  ru: {
    ...
    home_photo_food:"Фото еды", home_ask_coach:"Спросить тренера",
  ...
  en: {
    ...
    home_photo_food:"Photo food", home_ask_coach:"Ask coach",
  ...
  uz: {
    ...
    home_photo_food:"Ovqat surati", home_ask_coach:"Murabbiyga savol",
  ...
  kz: {
    ...
    home_photo_food:"Тамақ суреті", home_ask_coach:"Жаттықтырушыдан сұрау",
...
function MenuScreen({user,onNav,activeWorkout=false}){
  ...
  return <div style={{padding:"16px 16px 100px"}}>
    ...
    <div onClick={()=>onNav("more")} style={{display:"flex",alignItems:"center",gap:10,marginBottom:16,cursor:"pointer"}}>
    ...
    <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8}}>
      <Card onClick={()=>onNav("food_vision")} pad="12px 14px">
        <div style={{display:"flex",alignItems:"center",gap:9}}>
          <span style={{fontSize:17}}>📷</span>
          <span style={{fontSize:14,color:C.text}}>{t("home_photo_food")}</span>
        </div>
      </Card>
      <Card onClick={()=>onNav("tab_ai")} pad="12px 14px">
        <div style={{display:"flex",alignItems:"center",gap:9}}>
          <span style={{fontSize:17}}>💬</span>
          <span style={{fontSize:14,color:C.text}}>{t("home_ask_coach")}</span>
        </div>
      </Card>
    </div>
