...
Дай короткую оценку (3-4 предложения): что хорошо, что улучшить, совет на следующую тренировку.`;
  ...
  if(step===STEP.MD)return(
    <div style={{padding:"16px 16px 100px"}}>
      ...
      <Card onClick={()=>setStep(STEP.SG)} style={{marginBottom:12,cursor:"pointer",padding:"12px 16px",textAlign:"center"}}>
        <span style={{color:C.accent,fontSize:13,fontFamily:"monospace",fontWeight:700}}>{t("show_all_exercises")||"ПОКАЗАТЬ ВСЕ УПРАЖНЕНИЯ"} →</span>
      </Card>
      {!showSports?(
