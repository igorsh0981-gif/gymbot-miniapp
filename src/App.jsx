    ...
    <div style={{padding:"16px 16px 100px"}}>
      ...
      {!preview?(
        <div onClick={()=>inputRef.current?.click()}
          ...
          <div style={{fontSize:14,color:C.text,fontWeight:600,marginBottom:4}}>Сфотографировать еду</div>
          <div style={{fontSize:12,color:C.muted}}>или выбрать из галереи</div>
        </div>
      ):(
        <div style={{marginBottom:16}}>
