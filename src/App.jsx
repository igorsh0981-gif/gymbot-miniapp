  ...
  if(step===STEP.LG){
    ...
    return(
      <div style={{padding:"16px 16px 100px"}}>
        ...
        {/* Название упражнения */}
        <Hero style={{fontSize:22,marginBottom:4}}>{ex.name}</Hero>
        ...
        <button onClick={async()=>{
          ...
          style={{width:"100%",background:C.accent,border:"none",borderRadius:12,padding:"16px",color:C.bg,fontWeight:700,fontSize:16,cursor:"pointer",marginBottom:10,letterSpacing:0.5}}>
          ✓ ПОДХОД ВЫПОЛНЕН
        </button>
