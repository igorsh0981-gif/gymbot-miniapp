...
function AIScreen({user,tgId,onNav,exercises=[]}){
  ...
  return <div style={{padding:"16px 16px 100px"}}>
    ...
    {/* История чата */}
    {chatHistory.length>0&&<div style={{marginBottom:16}}>
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8}}>
    ...
    {!loading&&answer&&<Card accent>
      <Kicker>ПОСЛЕДНИЙ ОТВЕТ ТРЕНЕРА</Kicker>
      ...
      <div style={{display:"flex",gap:8,marginTop:12}}>
        <button onClick={()=>{setAnswer(null);setWorkoutPlan(null);setSaved(false);}}
