...
const T = {
  ru: {
    ...
    prog_this_week:"ТЕКУЩАЯ НЕДЕЛЯ", week_gym:"зал", week_sport:"спорт",
  ...
  en: {
    ...
    prog_this_week:"THIS WEEK", week_gym:"gym", week_sport:"sport",
  ...
  uz: {
    ...
    prog_this_week:"SHU HAFTA", week_gym:"zal", week_sport:"sport",
  ...
  kz: {
    ...
    prog_this_week:"АҒЫМДАҒЫ АПТА", week_gym:"зал", week_sport:"спорт",
...
function ActiveWorkoutScreen({tgId,exercises,muscleGroups,onBack,onFinish,onFinishNav=null,onNav=null,preselectedExIds=[],preselectedGroupIds=[],plannedWorkoutId=null,exerciseTips={}}){
  ...
  useEffect(()=>{
    ...
    if(!src)return;
    setLocalSet(p=>(p.reps===""&&p.weight==="")
      ?{...p,reps:src.reps?String(src.reps):"",weight:src.weight?String(src.weight):""}
      :p);
