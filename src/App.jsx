    ...
    {user&&<>
      ...
      {profileComplete&&<Card onClick={()=>onNav("profile")} style={{marginTop:8,marginBottom:8}}>
        ...
        <div style={{borderTop:`0.5px solid ${C.border}`,marginTop:10,paddingTop:10,display:"flex",gap:16}}>
          ...
          <div><div style={{fontSize:10,color:C.muted,fontFamily:"monospace"}}>{t("status_section")}</div><Mono size={11}>{user.rank_name||"🥉 Новичок"}</Mono></div>
        </div>
      </Card>}
  ...
  return <div style={{padding:"16px 16px 100px"}}>
    ...
    <Card style={{marginBottom:16}}>
      <div style={{fontSize:13,color:C.muted,lineHeight:1.6}}>
        ...
        <span style={{color:C.accent}}>{t("ai_trainer_title")}</span> учитывает твой чек-ин при составлении планов, ответах и советах.
      </div>
    </Card>
    <div style={{height:8}}/>
    {sent
